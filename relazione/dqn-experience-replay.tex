...
\section{Sessioni di apprendimento}
	...
	\subsection{Centipede}
		...
		\subsubsection{Risultati}
			...
			È stato campionato un valore massimo di $5337,33$ ($32,8\%$ delle prestazioni umane) con una deviazione standard di $1756$. Si possono anche osservare partite in cui DQN \textbf{supera lo score medio umano} con un punteggio di $12431$ punti. Tuttavia, gli altissimi valori delle deviazioni sia in \cite{bib:dqn} che qui osservati, suggeriscono che enormi punteggi in \textit{Centipede} si possono fare solo sotto particolari condizioni favorevoli.
		
%										1. 18mln anche per centipede, ma è stato ottenuto un balanale 600p, significa -23%
%										3. ma questo significa che l'agente "si impegna" a fare un punteggio peggiore, perché?
%										4. è a causa della struttura del gioco, dopo aver sparato al centipede esso si suicida per guadagnare punti
%		2. è stato notato che dopo un 1mln ne faceva di più
%		5. si suicida contro il ragno perché poi ottiene , ma è al contrario l'uccisione del ragno a far ingrandire enormemente i punteggi
%		- mentre un pezzo di centipede regala 10 punti, il ragno ne regala dai 300 a 900
%		- dqn non può estrarre informazioni del genere, un pezzo di centipede fa +1 e il ragno fà sempre +1
%		- per come è progettato, dqn non può sapere che l'uccisione del ragno conviene rispetto alla morte in seguit alla quale ottiene parecchi punteggi
%		
%	Deep 30 samples
%		250k	stupido
