...
\title{Apprendimento per Rinforzo:\\Agente Deep Q\texttwelveudash Network e\\ cause di inefficacia} % Article title
\author{%
...
\begin{figure*}[ht!]
	\centering
	\caption{Implementazione del layer FC e layer lineare}
